...
app.use((req, res, next) => {
  ...
  if (req.path === '/api/voters/compare-phones' || req.path === '/api/voters/enrich-phones' || req.path === '/api/voters/bulk-enrich-phones') return next();
